...
// Micro stats row (strong / basic / missing counts)
// Skill badges in masonry-style grouped grid
// Badges fly in with spring stagger
// Strong badges glow pulse every few seconds
// ─────────────────────────────────────────────────────
...
function SkillBadge({ skill, index }) {
  ...
  const colors          = C[`skill${skill.level.charAt(0).toUpperCase() + skill.level.slice(1)}`]
                          || C.skillMissing
  ...
  return (
    <div id="act2-skills" ref={ref}>
      <div style={{
        ...
        >
          <SkillGlobe skills={skills} size={380} />
        </motion.div>
